...
namespace ClosedLoopEconomicsGame.View.Controls.GameControls
{
    ...
    public partial class CountdownTimerControl : UserControl, ICountdownTimerController
    {
        ...
        private TimeSpan _remainingPauseTime;
        ...
        {
            {
                if (_isPaused)
                {
                    _interval = _remainingPauseTime;
                    _startTime = DateTime.Now - (_interval - _remainingPauseTime);
                    _isPaused = false;
                }
                else
                {
        ...
        public void Pause()
        {
            if (_countdownTimer.IsEnabled)
            {
                ...
                _remainingPauseTime = RemainingTime;
                _isPaused = true;
            }
        }
